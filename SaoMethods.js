...
Sao.config.bug_url = 'https://dashboard.kalenislims.com/';
Sao.config.title = 'Kalenis';
...
Sao.Tab.prototype.close = function () {
    ...
    return this._close_allowed().then(function () {
        ...
        react_tree.each(function (i, element) {
            ...
            var deleted = window.KalenisAddons.Components.delete(element);
...
Sao.View.Form.HTML.prototype.display = function () {
    ...
    window.KalenisAddons.Components.createHtmlField({
...
Sao.Window.Search.prototype.response = function (response_id) {
    ...
    if (react_nodes[0]) {
        window.KalenisAddons.Components.delete(react_nodes[0]);
    }
